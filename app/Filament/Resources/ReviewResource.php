    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                Forms\Components\Textarea::make('comment')->disabled(),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('comment')->limit(50)->label('Komentar'),
                Tables\Columns\IconColumn::make('is_visible')->label('Disetujui')->boolean(),
            ...
            ->actions([
                ...
                Tables\Actions\Action::make('approve')
                    ...
                    ->color('success')
                    ->action(fn (Review $record) => $record->update(['is_visible' => true]))
                    ->visible(fn (Review $record) => ! $record->is_visible),
